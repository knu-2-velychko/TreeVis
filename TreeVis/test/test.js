...
describe('Binary Tree Iterator', () => {
    it('Binary Search Tree', () => {
        ...
        chai.expect(iterator.getCurrent.key).to.equal(3);
        chai.expect(iterator.getDepth).to.equal(0);
        chai.expect(iterator.getPos).to.equal(0);
        iterator.next();
        chai.expect(iterator.getCurrent.key).to.equal(2);
        chai.expect(iterator.getDepth).to.equal(1);
        chai.expect(iterator.getPos).to.equal(0);
        iterator.next();
        chai.expect(iterator.getCurrent.key).to.equal(5);
        chai.expect(iterator.getDepth).to.equal(1);
        chai.expect(iterator.getPos).to.equal(1);
        iterator.next();
        chai.expect(iterator.getCurrent.key).to.equal(1);
        chai.expect(iterator.getDepth).to.equal(2);
        chai.expect(iterator.getPos).to.equal(0);
        iterator.next();
...
describe('Get matrix of treeView', () => {
    it('Binary Search Tree', () => {
        ...
        tree.insertKey(2);
        tree.insertKey(1);
        let matrix = makeMatrix(tree);
        chai.expect(matrix.length).to.equal(3);
        chai.expect(matrix[0][0].pos).to.equal(0);
        chai.expect(matrix[0][0].node.key).to.equal(3);
        chai.expect(matrix[1][0].pos).to.equal(0);
        chai.expect(matrix[1][0].node.key).to.equal(2);
